...
<body >
	<form method="POST" action="../logics/editProfileCheck.php" >
		<table align= "center" border="1" width=100% height=700px style="background-color:#FF8000;">
			...
			<tr style="background-color:white;">
				...
				<h2 style="color:black;">
					...
					PASSWORD: <input type="password" name="password" value="123" placeholder="Password" size="30"><br><br>
					LOCATION: <input type="text" name="phone"><br><br>
				</h2>
